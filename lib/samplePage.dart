...
//
//   List<String> allLists = ['Basic', 'Medium', 'Advance'];
//
//   @override
...
//     );
  ...
  /* ---- */
    ...
    //             child: Text(allLists[0], style: TextStyle(fontSize: 22))),
    //       ),
    //     );
    //   }),
    // ),
...
void main(){
  ...
  var value = ["I", "B", "C", "A", "D", "F"];
  var list = ['Aman', 'B', 'Fish', 'C', 'fgA', 'hhcc', 'F', "A"];
  list.sort((a, b) {
  ...
  for (var el in list) {
    bool isContains = value.contains((el));
    if(isContains) {
      // print(el);
      check.add(el);
    }
  ...
  var set2 = value.toSet();
  var contains = list.any(set2.contains);
  print(contains);

  // print("Second List: ${isIntersect(value, list)}");
